  ...
  return (
    <section className="py-16 md:py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-2">Our Best Sellers</h2>
        <p className="text-slate-600 mb-12 max-w-2xl">
          Formulated with science-based all-natural ingredients and backed by clinical research to support your health
          goals.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {products.map((product, idx) => (
            <div key={idx} className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-200">
