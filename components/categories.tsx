  ...
  return (
    <section className="py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-4">Nutrition Solutions</h2>
        <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">for Your Complete Well-Being</p>
          ...
          {categories.map((category, idx) => {
            ...
            return (
              ...
              >
                ...
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition duration-200">
                  Shop Now
                </button>
              </div>
            )
